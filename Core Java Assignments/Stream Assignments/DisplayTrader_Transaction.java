...
public class DisplayTrader_Transaction {
	public static void main(String[] args) {
		Trader t1=new Trader("Aayush", "Kolkata");
		Trader t2=new Trader("Akshay", "Pune");
		Trader t3=new Trader("Bhavanish", "Lucknow");
		Trader t4=new Trader("Amalan", "Pune");
		Trader t5=new Trader("Ayush", "Delhi");
